...
#define MAVLINK_MSG_ID_heartbeat_CRC 151
#define MAVLINK_MSG_ID_0_CRC 151
...
#define MAVLINK_MESSAGE_INFO_heartbeat { \
    ...
    "heartbeat", \
    3, \
    {  { "addr", NULL, MAVLINK_TYPE_UINT8_T, 6, 0, offsetof(mavlink_heartbeat_t, addr) }, \
         { "sys_stat", NULL, MAVLINK_TYPE_UINT8_T, 0, 6, offsetof(mavlink_heartbeat_t, sys_stat) }, \
         { "err_code", NULL, MAVLINK_TYPE_UINT8_T, 0, 7, offsetof(mavlink_heartbeat_t, err_code) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_heartbeat { \
...
static inline uint16_t mavlink_msg_heartbeat_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               const uint8_t *addr, uint8_t sys_stat, uint8_t err_code)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_heartbeat_LEN];
    _mav_put_uint8_t(buf, 6, sys_stat);
    _mav_put_uint8_t(buf, 7, err_code);
...
{
    return mavlink_msg_heartbeat_pack(system_id, component_id, msg, heartbeat->addr, heartbeat->sys_stat, heartbeat->err_code);
}
...
{
    return mavlink_msg_heartbeat_pack_chan(system_id, component_id, chan, msg, heartbeat->addr, heartbeat->sys_stat, heartbeat->err_code);
}
...
static inline void mavlink_msg_heartbeat_send(mavlink_channel_t chan, const uint8_t *addr, uint8_t sys_stat, uint8_t err_code)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_heartbeat_LEN];
    _mav_put_uint8_t(buf, 6, sys_stat);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_heartbeat_send(chan, heartbeat->addr, heartbeat->sys_stat, heartbeat->err_code);
#else
 ...
 */
static inline void mavlink_msg_heartbeat_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  const uint8_t *addr, uint8_t sys_stat, uint8_t err_code)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
