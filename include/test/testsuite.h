...
static void mavlink_test_query(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_query_t packet_in = {
        { 5, 6, 7, 8, 9, 10 },151,218,{ 29, 30, 31, 32, 33, 34 }
    };
...
static void mavlink_test_query_result(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_query_result_t packet_in = {
        17.0,45.0,{ 29, 30, 31, 32, 33, 34 },{ 175, 176, 177, 178, 179, 180 },65
    };
    ...
    mavlink_msg_query_result_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_query_result_pack(system_id, component_id, &msg , packet1.addr , packet1.match_addr , packet1.is_usable , packet1.x , packet1.y );
    mavlink_msg_query_result_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_query_result_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.addr , packet1.match_addr , packet1.is_usable , packet1.x , packet1.y );
    mavlink_msg_query_result_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_query_result_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_query_result_send(MAVLINK_COMM_1 , packet1.addr , packet1.match_addr , packet1.is_usable , packet1.x , packet1.y );
    mavlink_msg_query_result_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
