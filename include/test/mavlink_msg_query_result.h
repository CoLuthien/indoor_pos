...
#define MAVLINK_MSG_ID_query_result_CRC 208
#define MAVLINK_MSG_ID_3_CRC 208
...
#define MAVLINK_MESSAGE_INFO_query_result { \
    ...
    {  { "addr", NULL, MAVLINK_TYPE_UINT8_T, 6, 8, offsetof(mavlink_query_result_t, addr) }, \
         { "match_addr", NULL, MAVLINK_TYPE_UINT8_T, 6, 14, offsetof(mavlink_query_result_t, match_addr) }, \
         { "is_usable", NULL, MAVLINK_TYPE_UINT8_T, 0, 20, offsetof(mavlink_query_result_t, is_usable) }, \
...
static inline uint16_t mavlink_msg_query_result_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               const uint8_t *addr, const uint8_t *match_addr, uint8_t is_usable, float x, float y)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_query_result_LEN];
    _mav_put_float(buf, 0, x);
    _mav_put_float(buf, 4, y);
    _mav_put_uint8_t(buf, 20, is_usable);
    _mav_put_uint8_t_array(buf, 8, addr, 6);
    _mav_put_uint8_t_array(buf, 14, match_addr, 6);
...
{
    return mavlink_msg_query_result_pack(system_id, component_id, msg, query_result->addr, query_result->match_addr, query_result->is_usable, query_result->x, query_result->y);
}
...
{
    return mavlink_msg_query_result_pack_chan(system_id, component_id, chan, msg, query_result->addr, query_result->match_addr, query_result->is_usable, query_result->x, query_result->y);
}
...
static inline void mavlink_msg_query_result_send(mavlink_channel_t chan, const uint8_t *addr, const uint8_t *match_addr, uint8_t is_usable, float x, float y)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_query_result_LEN];
    _mav_put_float(buf, 0, x);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_query_result_send(chan, query_result->addr, query_result->match_addr, query_result->is_usable, query_result->x, query_result->y);
#else
 ...
 */
static inline void mavlink_msg_query_result_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  const uint8_t *addr, const uint8_t *match_addr, uint8_t is_usable, float x, float y)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
{
    return _MAV_RETURN_uint8_t_array(msg, match_addr, 6,  14);
}
